...
#include "vsr/rendering/index/TransformsToAnariVisitor.hpp"
// std
#include <algorithm>
#include <iterator>
...
{
  if (o->useCount(vsr::scene::Object::UseKind::LAYER) > 0)
    return;
...
{
  if (o->useCount(vsr::scene::Object::UseKind::PARAMETER) > 0)
    return;
  m_cache.releaseHandle(o);
#if 0
    vsr::core::logDebug(
