...
#include "vsr/core/algorithms/vort.h"
#if VSR_USE_CUDA
#include "vsr/core/algorithms/vort_cuda.h"
#endif
// nanovdb
    ...
    VorticityOptions opts)
{
  ...
  const auto *rawPos = posArr->dataAs<vsr::math::float3>();
...
#endif // VSR_USE_CUDA || VSR_USE_VTK (inner)

  return result;
}

#endif // VSR_USE_CUDA || VSR_USE_VTK
