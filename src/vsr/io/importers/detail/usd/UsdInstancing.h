...
struct InstancerPlacements
{
  ...
  std::vector<vsr::math::mat4> transforms;
  ...
  std::vector<vsr::math::mat4> forPrototype(size_t prototypeIndex) const;
};
...
struct InstancerRegistry
{
  ...
  VSR_NOT_COPYABLE(InstancerRegistry)
  VSR_DEFAULT_MOVEABLE(InstancerRegistry)
