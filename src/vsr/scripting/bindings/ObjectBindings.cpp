...
template <typename T>
auto registerObjectPoolRef(sol::table &vsr, const char *name)
{
  using Ref = scene::ObjectPoolRef<T>;
  auto refType = vsr.new_usertype<Ref>(
      name,
      sol::no_constructor,
      "valid",
      &Ref::valid,
...
void registerObjectBindings(sol::state &lua)
{
  ...
  // Then register Ref types which overwrite vsr["Name"] table entries.

  vsr.new_usertype<scene::Geometry>("Geometry",
      sol::no_constructor,
      sol::base_classes,
      sol::bases<scene::Object>());

  vsr.new_usertype<scene::Material>("Material",
      sol::no_constructor,
      sol::base_classes,
      sol::bases<scene::Object>());

  vsr.new_usertype<scene::Light>("Light",
      sol::no_constructor,
      sol::base_classes,
      sol::bases<scene::Object>());

  vsr.new_usertype<scene::Camera>("Camera",
      sol::no_constructor,
      sol::base_classes,
      sol::bases<scene::Object>());

  vsr.new_usertype<scene::Surface>(
      "Surface",
      sol::no_constructor,
      sol::base_classes,
      sol::bases<scene::Object>(),
  ...
  vsr.new_usertype<scene::Volume>("Volume",
      sol::no_constructor,
      sol::base_classes,
      sol::bases<scene::Object>(),
      "spatialField",
  ...
  vsr.new_usertype<scene::Sampler>("Sampler",
      sol::no_constructor,
      sol::base_classes,
      sol::bases<scene::Object>());

  vsr.new_usertype<scene::SpatialField>(
      "SpatialField",
      sol::no_constructor,
      sol::base_classes,
      sol::bases<scene::Object>(),
  ...
  registerObjectPoolRef<scene::Geometry>(vsr, "Geometry");
  registerObjectPoolRef<scene::Material>(vsr, "Material");
  registerObjectPoolRef<scene::Light>(vsr, "Light");
  registerObjectPoolRef<scene::Camera>(vsr, "Camera");
  registerObjectPoolRef<scene::Sampler>(vsr, "Sampler");

  auto surfaceRefType = registerObjectPoolRef<scene::Surface>(vsr, "Surface");
  ...
  auto volumeRefType = registerObjectPoolRef<scene::Volume>(vsr, "Volume");
  ...
  auto fieldRefType =
      registerObjectPoolRef<scene::SpatialField>(vsr, "SpatialField");
  ...
  auto arrayRefType = registerObjectPoolRef<scene::Array>(vsr, "Array");
