...
Entry build1DColor(SDL_Renderer *r, const vsr::scene::Array &a)
{
...
Entry build2DColor(SDL_Renderer *r, const vsr::scene::Array &a)
{
...
Entry buildEntry(SDL_Renderer *r, const vsr::scene::Array &a)
{
...
const Entry *getOrCreate(const vsr::scene::Array &a)
{
  auto &c = cache();
  if (!c.renderer)
    return nullptr;
...
bool buildUI_array_preview(const vsr::scene::Array &a, float maxDim)
{
