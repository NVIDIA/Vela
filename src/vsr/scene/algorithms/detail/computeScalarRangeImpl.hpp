...
inline vsr::math::float2 computeScalarRangeImpl(const Array &a)
{
  using properties_t = anari::ANARITypeProperties<ANARI_ENUM_T>;
  using base_t = typename properties_t::base_type;
  vsr::math::float4 min_out{0.f, 0.f, 0.f, 0.f};
  vsr::math::float4 max_out{0.f, 0.f, 0.f, 0.f};
...
//             times.
vsr::math::float2 computeScalarRange_ufixed8(const Array &a);
vsr::math::float2 computeScalarRange_ufixed16(const Array &a);
vsr::math::float2 computeScalarRange_fixed8(const Array &a);
vsr::math::float2 computeScalarRange_fixed16(const Array &a);
