...
struct ObjectDatabase
{
  ...
  VSR_NOT_MOVEABLE(ObjectDatabase)
  VSR_NOT_COPYABLE(ObjectDatabase)
};
...
struct Scene
{
  ...
  VSR_NOT_MOVEABLE(Scene)
  VSR_NOT_COPYABLE(Scene)
 ...
 private:
  friend bool ::vsr::io::deserialize_CameraArchive(
      Scene &, core::DataNode &, ::vsr::io::ArchiveValidationResult *);
...
inline ObjectPoolRef<T> Scene::createObject(Token subtype)
{
  static_assert(std::is_base_of<Object, T>::value,
      "Scene::createObject<> can only create vsr::Object subclasses");
  static_assert(!std::is_same<T, Array>::value,
      "Use Scene::createArray() to create vsr::Array objects");
  static_assert(!std::is_same<T, Renderer>::value,
      "Use Scene::createRenderer() to create vsr::Renderer objects");
  return {};
}
...
{
  static_assert(std::is_base_of<Object, T>::value,
      "Scene::getObject<> can only get vsr::Object subclasses");
  return {};
}
