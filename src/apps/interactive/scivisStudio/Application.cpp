...
Application::Application(int argc, const char **argv)
    : VSRApplication(argc, argv), m_projectContext(appContext())
{
...
vsr::ui::imgui::WindowArray Application::setupWindows()
{
  ...
  auto *objectEditor = new vsr_ui::ObjectEditor(this);
  m_layerTree = new vsr_ui::LayerTree(this);
  m_transferFunctionEditor = new vsr_ui::TransferFunctionEditor(this);
