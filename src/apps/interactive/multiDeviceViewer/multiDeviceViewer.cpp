...
#include <vsr/ui/imgui/windows/MultiDeviceViewport.h>
...
class Application : public VSRApplication
{
 public:
  ...
  vsr::ui::imgui::WindowArray setupWindows() override
  {
    ...
    auto *viewport = new vsr_ui::MultiDeviceViewport(
        this, &ctx->view.manipulator, "Viewport");
    auto *cameras = new vsr_ui::CameraPoses(this, nullptr);
...
{
  {
    ...
    app.run(1920, 1080, "VSR Multi-Device Viewer");
  }
