...
DistributedViewport::DistributedViewport(vsr::ui::imgui::Application *app,
...
void DistributedViewport::setManipulator(vsr::rendering::Manipulator *m)
{
...
void DistributedViewport::resetView(bool resetAzEl)
{
  ...
  if (!anariGetProperty(m_device,
          ...
          sizeof(bounds),
          ANARI_WAIT)) {
    vsr::core::logWarning("No bounds returned by the ANARIWorld!");
  }
#endif
...
void DistributedViewport::reshape(vsr::math::int2 newSize)
{
  ...
  if (ImGui::BeginMenuBar()) {
    ...
    if (ImGui::BeginMenu("World")) {
      if (ImGui::MenuItem("print bounds")) {
        vsr::core::logWarning("TODO: implement world bounds printout\n");
#if 0
