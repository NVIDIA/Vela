...
class Application : public VSRApplication
{
 public:
  ...
  vsr::ui::imgui::WindowArray setupWindows() override
  {
    ...
    auto *solver = new vsr::demo::SolverControls(this);
    ...
    auto colorArray = ctx->vsr.scene.createArray(ANARI_FLOAT32_VEC4, 256);
    colorArray->setData(
        vsr::core::makeDefaultColorMap(colorArray->size()).data());
...
{
  {
    ...
    app.run(1920, 1080, "VSR Demo | Animated Volume");
  }
