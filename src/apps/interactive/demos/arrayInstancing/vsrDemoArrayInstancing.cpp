...
class Application : public VSRApplication
{
 public:
  ...
  vsr::ui::imgui::WindowArray setupWindows() override
  {
    ...
    viewport2->hide();
    auto *icontrols = new vsr::demo::InstancingControls(this, "Scene Controls");
    ...
    manipulator->setConfig(vsr::math::float3(2.743f, 4.747f, 0.944f),
        90.f,
        vsr::math::float2(180.f, 0.f));
...
{
  {
    ...
    app.run(1920, 1080, "VSR Demo | Array Instancing");
  }
