...
using vsr::scene::MaterialRef;
using vsr::scene::Object;
using vsr::scene::ObjectUsePtr;
using vsr::scene::Scene;
namespace material = vsr::scene::tokens::material;

SCENARIO("vsr::scene::ObjectUsePtr interface", "[ObjectUsePtr]")
{
  Scene scene;
