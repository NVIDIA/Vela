# Delegate file-animation I/O to VSR

A file-animation dataset persists the one authoritative ordered source-file
list and enough VSR state to recreate a core file-animation object together
...
`.vsr` contains its source list and current scene representation, not an
